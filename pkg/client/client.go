...
func (c *Client) UpdateIngressController(ctx context.Context, ic *operatorv1.IngressController) (*operatorv1.IngressController, error) {
...
func (c *Client) UpdateTLSSecurityProfile(ctx context.Context, name string, profile *configv1.TLSSecurityProfile) error {
	ic, err := c.GetIngressController(ctx, name)
	if err != nil {
		return err
	}
